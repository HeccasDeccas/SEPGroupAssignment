     ...
     <body>
        ...
        <h3>Please choose from the following options:</h3>
            ...
            <table class="dashboardButtons">
                ...
                <tr><td><input type="submit" name="viewAllStationeryRequests" class="button" onclick="window.location.href='receptionistViewOrders.jsp'" value="View All Stationery Requests"></td></tr>
                <tr><td>
